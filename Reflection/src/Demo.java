...
{ 
    ...
    { 
        ...
        Test obj = new Test(); // Creating object whose property is to be checked 
       ...
       // Getting methods of the class through the object of the class by using getMethods 
        ...
        // creates object of desired method by providing the method name and parameter class as arguments to
        ...
        // Creates object of the desired method by providing the name of method as argument to the  
